    ...
    <div className="bg-[#F8FAFC] min-h-screen pt-28 pb-20">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <Section title={p.s2}>
          ...
          <p className="mt-2"><strong>Limited Use disclosure.</strong> Ozly&rsquo;s use and transfer to any other app of information received from Google APIs will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noopener noreferrer" className="text-brand-600 underline">Google API Services User Data Policy</a>, including the Limited Use requirements. Specifically: we use Google Calendar data only to provide and improve the calendar-sync feature you enabled; we do <strong>not</strong> use it for advertising; we do <strong>not</strong> sell it; we do <strong>not</strong> transfer it to third parties except as necessary to provide the feature, comply with applicable law, or as part of a merger or acquisition; and we do <strong>not</strong> allow humans to read it unless we have your consent for specific items, it is necessary for security or to comply with the law, or the data is aggregated and anonymised.</p>
        ...
        <Section title={p.s13}>
          ...
          <ul>
            <li><strong>Email:</strong> <a href="mailto:contact@ozly.com.au">contact@ozly.com.au</a></li>
